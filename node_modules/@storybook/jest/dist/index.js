...
).expect, validMatchers = { ...matchers };
Object.keys(validMatchers).forEach((matcherName) => {
  let matcher = validMatchers[matcherName];
  (typeof matcher > "u" || typeof matcher == "boolean") && delete validMatchers[matcherName];
});
